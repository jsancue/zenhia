              ...
              >
                <Paper
                    ...
                    sx={{
                      ...
                      boxShadow: (theme) => theme.shadows[6], // Changed
                      border: "1px solid",
                      borderColor: "divider",
                    }}
                >
                  ...
                  >
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      <Avatar
                          // src="/placeholder.svg?height=40&width=40" // Placeholder
                          alt="Zen Assistant"
                          sx={{
                            mr: 1,
                            bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary.contrastText : 'white', // Adjusted for contrast
                            boxShadow: (theme) => theme.shadows[1], // Added theme shadow
                          }}
                      >
                        <ChatIcon sx={{ color: theme.palette.primary.main }}/> {/* Ensured icon color contrasts with new Avatar bgcolor */}
                      </Avatar>
                                    ...
                                    sx={{
                                      ...
                                      bgcolor:
                                          message.sender === "user"
                                              ...
                                              : mode === "light"
                                                  ? "background.paper"
                                                  : "grey.800", // This grey might need adjustment for contrast with text.primary in dark mode
                                      color: message.sender === "user" ? (theme) => theme.palette.primary.contrastText : "text.primary", // Changed
                            ...
                            >
                              <Box
                                  sx={{
                                    ...
                                    bgcolor: mode === "light" ? "background.paper" : "grey.800", // This grey might need adjustment
                                    boxShadow: (theme) => theme.shadows[1], // Changed
                                    display: "flex",
                                    alignItems: "center",
                                  }}
