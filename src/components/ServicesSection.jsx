...
export default function ServicesSection() {
    ...
    // TODO: Externalize services data
    const services = [
        {
            id: "manicure",
                            ...
                            >
                                <Card
                                    sx={{
                                        ...
                                        border: (theme) => `1px solid ${theme.palette.divider}`, // Changed
                                        "&:hover": {
                                            transform: "translateY(-8px)",
                                            boxShadow: (theme) => theme.shadows[4], // Changed
                                            "& img": {
                                                transform: "scale(1.05)", // Already present, ensure it targets LazyImage's img
                                            },
                                        },
                                    }}
                                >
                                    <Box sx={{ position: "relative", overflow: "hidden", height: 200 }}>
                                        <LazyImage // Changed from CardMedia
                                            src={service.image}
                                            alt={service.title}
                                            sx={{
                                                height: "100%", // Ensure LazyImage fills the container
                                                width: "100%",
                                                objectFit: "cover",
                                        ...
                                        >
                                            <Typography
                                                variant="caption"
                                                sx={{
                                                    bgcolor: theme.palette.primary.main, // Changed
                                                    color: theme.palette.primary.contrastText, // Changed
                                                    py: 0.5,
                                                    px: 1.5,
                                                    borderRadius: 5,
                                                    fontWeight: "medium",
                                            ...
                                            >
                                                <Box
                                                    sx={{
                                                        ...
                                                        height: 40,
                                                        borderRadius: "50%",
                                                        bgcolor: (theme) => alpha(theme.palette.primary.main, 0.1), // Changed
                                                        color: "primary.main",
                                                        mr: 1.5,
                                                    }}
                                                >
                                            ...
                                            <Button
                                                ...
                                                sx={{
                                                    ...
                                                    "&:hover": {
                                                        ...
                                                        boxShadow: theme.shadows[4], // Example: Use theme shadow
                                                    },
