...
import { Box, Typography, Container, Paper, Avatar, Rating, IconButton, useTheme, alpha } from "@mui/material" // Added alpha
// import { alpha } from '@mui/material/styles'; // Alternative if above doesn't work
...
export default function TestimonialsSection() {
    ...
    // const { alpha } = theme.palette.common; // Removed incorrect alpha

    // TODO: Externalize testimonials data
    const testimonials = [
        {
            id: 1,
            name: "María García",
        ...
        <>
            <Box
                ...
                sx={{
                    ...
                    left: { xs: -50, md: -100 },
                    borderRadius: "50%",
                    background: `radial-gradient(circle, ${alpha(theme.palette.primary.light, 0.15)}, transparent 70%)`, // Corrected
                    zIndex: 0,
                }}
            />
            <Box
                        ...
                        >
                            <Paper
                                ...
                                sx={{
                                    ...
                                    bgcolor: "background.paper", // Changed
                                }}
                            >
                                <FormatQuoteIcon
                                    sx={{
                                        ...
                                        left: 20,
                                        fontSize: 40,
                                        color: (theme) => alpha(theme.palette.primary.main, 0.2), // Changed
                                    }}
                                />
                                <Box
                                    sx={{
                                        ...
                                        height: 100,
                                        borderRadius: "50%",
                                        background: (theme) => `linear-gradient(135deg, ${alpha(theme.palette.accent.light, 0.1)} 0%, ${alpha(theme.palette.accent.main, 0.1)} 100%)`, // Adjusted
                                    }}
                                />
                                <Avatar
                                    ...
                                    sx={{
                                        ...
                                        mx: "auto",
                                        mb: 2,
                                        border: (theme) => `3px solid ${theme.palette.background.paper}`, // Changed
                    ...
                    {testimonials.map((_, index) => (
                        <Box
                            ...
                            sx={{
                                ...
                                borderRadius: "50%",
                                mx: 0.5,
                                bgcolor: index === activeIndex ? "primary.main" : (theme) => alpha(theme.palette.text.primary, 0.2), // Changed
                                cursor: "pointer",
                                transition: "all 0.3s ease",
                                "&:hover": {
                                    transform: "scale(1.2)",
                                    bgcolor: index === activeIndex ? "primary.main" : (theme) => alpha(theme.palette.text.primary, 0.3), // Adjusted hover
                                },
                            }}
                        />
                    ))}
