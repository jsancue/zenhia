...
import { Box, Typography, Container, Grid, Link, IconButton, Divider, useTheme, Stack } from "@mui/material"
          ...
          <Grid item xs={12} md={4}>
            ...
            <Stack direction="row" spacing={1.5}>
              <IconButton
                ...
                target="_blank"
                sx={{
                  bgcolor: theme.palette.mode === "light" ? "rgba(212, 165, 165, 0.1)" : "rgba(255, 255, 255, 0.05)",
                  color: theme.palette.mode === "light" ? "#9E7777" : "rgba(255, 255, 255, 0.8)",
                  transition: "all 0.3s ease",
                  "&:hover": {
                    bgcolor: theme.palette.mode === "light" ? "rgba(212, 165, 165, 0.2)" : "rgba(255, 255, 255, 0.1)",
