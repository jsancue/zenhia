                ...
                <Grid item xs={12} sm={6}>
                  <Paper
                    ...
                    sx={{
                      ...
                      background: "linear-gradient(135deg, rgba(212, 165, 165, 0.05) 0%, rgba(255, 255, 255, 0) 100%)",
                      "&:hover": {
                        transform: "translateY(-5px)",
                        boxShadow: "0 10px 30px rgba(212, 165, 165, 0.15)",
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                      <Avatar
                        sx={{
                          ...
                          mr: 2,
                          boxShadow: "0 4px 8px rgba(212, 165, 165, 0.3)",
                        }}
                      >
                        <FlagIcon />
                      </Avatar>
                ...
                <Grid item xs={12} sm={6}>
                  <Paper
                    ...
                    sx={{
                      ...
                      borderRadius: 3,
                      transition: "all 0.3s ease",
                      border: `1px solid rgba(188, 154, 108, 0.2)`,
                      background: "linear-gradient(135deg, rgba(188, 154, 108, 0.05) 0%, rgba(255, 255, 255, 0) 100%)",
                      "&:hover": {
                        transform: "translateY(-5px)",
                        boxShadow: "0 10px 30px rgba(188, 154, 108, 0.15)",
                        borderColor: "rgba(188, 154, 108, 0.3)",
                      },
                    }}
                  >
                    <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                      <Avatar
                        sx={{
                          bgcolor: "accent.main",
                          mr: 2,
                          boxShadow: "0 4px 8px rgba(188, 154, 108, 0.3)",
                        }}
                      >
                        <VisibilityIcon />
                      </Avatar>
